<?php
	...
	if( isset($_POST['login']) ) {	
		...
		if (!$error) {
			...
			if ($count == 1 ) {
			 $sucMSG = "Paasword sent to email";
			  $to = $email;
            $subject = "YOUR NEW PASSWORD WITH MORRIS ODEH CHAMBERS FIRM";
            $message = "Dear $name, Your password is $pass";
            $headers = "From: morrisodeh.info@gmail.com";

			 
			header("refresh:1;url=login.php");
			} else {
			
			  $errMSG = "Your email is not recognised,sign up";
...
<head>
    <meta charset="utf-8">
    <title>MORRIS ODEH CHAMBERS</title>
...
<body>
  ...
  background-color:#00FFFF;">
			...
			?>
                    ...
                    <div>
                        <button class="btn btn-primary btn-block" type="submit" id="sendMessageButton" name="login">SEND</button>
